...
def test_criteria(
    ...
    return tokenizer.batch_decode(input_ids)[0].strip().endswith("仔细")  # When “仔细” is generated, trigger interruption
...
def invoke_test(
    ...
    return ["地想想看。" for _ in range(bsz)]  # When interruption triggered, force to generate “地想想看。”
